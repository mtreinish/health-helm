...
db:
	$(BUILDER) $(IMAGE_REG)$(HEALTH_DB_IMAGE):3 images/$(HEALTH_DB_IMAGE)

frontend:
	$(BUILDER) $(IMAGE_REG)$(HEALTH_FRONTEND_IMAGE):2 images/$(HEALTH_FRONTEND_IMAGE)

api-wait:
	$(BUILDER) $(IMAGE_REG)$(HEALTH_API_WAIT_IMAGE):2 images/$(HEALTH_API_WAIT_IMAGE)
